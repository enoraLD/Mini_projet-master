...
class CryptoFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        try {
           ...
           // curl_setopt($ch, CURLOPT_URL,"https://api.coingecko.com/api/v3/coins/markets?vs_currency=eur&category=cryptocurrency&order=market_cap_desc&per_page=50&page=$i&sparkline=false")
